    ...
    <div class="row">
      <div class="col-md-2">
        <div class="list-group">
          ...
          <a href="email.php" class="list-group-item">Subscribers </a>
     ...
     <table id="data-table-row-grouping" class="display" cellspacing="0" width="100%">                      
        ...
        <tbody>
        <?php 
          $sql = "SELECT visitors_name,email,phone_number,message FROM visitors_inquiries ";
